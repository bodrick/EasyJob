...
namespace WpfRichText
{
    ...
    internal static class HtmlSchema
    {
        ...
        internal static bool IsEmptyElement(string xmlElementName) =>
            ...
            _htmlEmptyElements.Contains(xmlElementName.ToLower(CultureInfo.InvariantCulture));
        ...
        internal static bool ClosesOnParentElementEnd(string xmlElementName) =>
            ...
            _htmlElementsClosingOnParentElementEnd.Contains(xmlElementName.ToLower(CultureInfo.InvariantCulture));
